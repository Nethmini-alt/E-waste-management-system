...
import SubmissionDashboardPage from './features/submissions/SubmissionDashboardPage';
import IndividualSubmissionPage from './features/submissions/IndividualSubmissionPage';
import CooperativeSubmissionPage from './features/submissions/CooperativeSubmissionPage';
import AIAssessmentPage from './features/submissions/AIAssessmentPage';
import SubmissionHistoryPage from './features/submissions/SubmissionHistoryPage';
import SubmissionReportPage from './features/submissions/SubmissionReportPage';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/submissions" element={<SubmissionDashboardPage />} />
          <Route path="/submissions/new" element={<SubmitPage />} />
          <Route path="/submissions/individual" element={<IndividualSubmissionPage />} />
          <Route path="/submissions/cooperative" element={<CooperativeSubmissionPage />} />
          <Route path="/submissions/assessment/:id" element={<AIAssessmentPage />} />
          <Route path="/submissions/history" element={<SubmissionHistoryPage />} />
          <Route path="/submissions/report/:id" element={<SubmissionReportPage />} />
          <Route
