...
namespace EWasteManagement.API.Migrations
{
    ...
    [Migration("20260921123900_RenameAIAnalysisValueToLkr")]
    partial class RenameAIAnalysisValueToLkr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EWasteManagement.API.Features.AgentWorkflows.Entities.AgentStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkflowId", "Agent", "StepName", "StartedAt")
                        .IsUnique()
                        .HasDatabaseName("ux_agent_steps_identity");

                    b.ToTable("agent_steps", null, t =>
                        {
                            t.HasCheckConstraint("ck_agent_steps_status", "status IN ('succeeded','failed','skipped')");
                        });
                });

            modelBuilder.Entity("EWasteManagement.API.Features.AgentWorkflows.Entities.AgentWorkflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExcludedCollectorIds")
                        .HasColumnType("jsonb")
                        .HasColumnName("excluded_collector_ids");
                    ...
                    b.ToTable("agent_workflows", null, t =>
                        {
                            t.HasCheckConstraint("ck_agent_workflows_status", "status IN ('planning','pendingapproval','revisioninprogress','completed','rejected','needsmanualreview')");
                        });
                });
            ...
            modelBuilder.Entity("EWasteManagement.Api.Entities.AIAnalysisResult", b =>
                {
                    ...
                    b.Property<decimal>("EstimatedValueLkr")
            ...
            modelBuilder.Entity("EWasteManagement.API.Features.AgentWorkflows.Entities.AgentStep", b =>
                {
                    b.HasOne("EWasteManagement.API.Features.AgentWorkflows.Entities.AgentWorkflow", "Workflow")
                        .WithMany("Steps")
