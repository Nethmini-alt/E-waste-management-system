    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    // The workflow pipeline can legitimately update the same workflow and
    // submission rows across queued stages. Using Postgres xmin as a global
    // optimistic concurrency token here introduces false conflicts in this app,
    // so we intentionally do not set a DB-wide concurrency token.
}
